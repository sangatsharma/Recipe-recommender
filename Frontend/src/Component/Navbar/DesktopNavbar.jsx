  ...
  return (
    <header className={`${isIdle ? "hide" : "show"}`}>
      ...
      <div className="Profile">
        ...
        {isAuthenticated && (
          <span title="Favourites" className="flex items-center justify-center  cursor-pointer m-auto pb-1 transition-all hover:scale-125 hover:border-b-2 border-orange-500 w-5 h-8 mr-2 ">
